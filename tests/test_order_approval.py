...
def test_approve_passes_body(mock_approve, mock_retrieve, mock_erred, mock_order):
    ...
    processor.backend = mock.Mock()
    processor.backend.supports_decreasing_usage = False
    ...
    with mock.patch(
        ...
        processor.backend.create_resource.return_value = BackendResourceInfo(
