...
## 1.0.1-rc.3 - 2026-03-23

- **Federation**: Add configurable `end_date_sync_direction` setting for controlling resource end date synchronization between Waldur instances.
...
> 9 commits, 38 files changed (+1329/-106 lines)
